...
<template>
  ...
  <div class="comeon-box" :style="{display:comeonShow?'grid':'none'}">
    <h1 class="title rainbow-text comeon-h1">高考加油!</h1>
    <div class="dot">
      <div class="dot-inner">
  ...
  <div class="end-words-box" :style="{display:endwords?'block':'none'}">
  <div class="end-words-left">
     <span clas="end-words-title">
            <span class="title-letter">披</span>
            <span class="title-letter">星</span>
            <span class="title-letter">戴</span>
            <span class="title-letter">月</span>
            <span class="title-letter">走</span>
            <span class="title-letter">过</span>
            <span class="title-letter">的</span>
            <span class="title-letter">路</span>
       <span class="title-letter">，</span>
        <span class="title-letter">终</span>
            <span class="title-letter">将</span>
            <span class="title-letter">繁</span>
            <span class="title-letter">花</span>
           <span class="title-letter">满</span>
           <span class="title-letter">地</span>
        </span>
  </div>
    <h1 id="sub-title"  class="title rainbow-text comeon-h1">祝所有考生高考大捷</h1>
  </div>
</template>
<script setup>
...
const comeonShow = ref(false)
const endwords = ref(false)
onMounted(()=>{
  showFireWorks();
  let letters = document.getElementsByClassName('title-letter');
  setTimeout(()=>{
    comeonShow.value = true
},5000)
  setTimeout(()=>{
    comeonShow.value = false
  },10000)
  setTimeout(() => {
    endwords.value = true
  ...
  // setTimeout(()=>{
  //   endwords.value = false
  // },20000)
})
</script>
<style lang="scss">
@import "assets/base.css";
@import "assets/fireworks";
#app {
  position: absolute;
  left: 0;
  top: 0;
